-- Espelho da otimização do backend de Outreach. O Injector compartilha o
-- mesmo Postgres e aplica esta migration antes da próxima carga. A listagem
-- usa a chave primária já existente; não criamos um GIN volumoso enquanto o
